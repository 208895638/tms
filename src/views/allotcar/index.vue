<template>
  ...
  <div class="Allotcar">
    <el-header class="Allotcar-header">
        <router-link to="./add"><el-button style='margin:0 0 5px 10px;' size="mini">新增</el-button></router-link>
...
export default {
  ...
  mounted() {
    ...
    document.querySelector('.el-table__body-wrapper').style.height = areaBoxHeight - 30 - 20 - 90 - buttonBoxHeight + 'px'
  ...
  methods: {
    init() { // 获取所有的配载单列表
      ...
      const data1 = {
        ...
        Departure_Org_Id: this.formFilter.site,
