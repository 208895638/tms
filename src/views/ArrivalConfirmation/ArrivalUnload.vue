  ...
  <div class="app-container AllotcarAdd">
    <div class="top">
        ...
        <el-tabs  type="card" @tab-click="handleClick">
            ...
            <el-tab-pane  label="二次配载"></el-tab-pane>
...
<!-- <div class="edit-page-modular" v-if="tab_show==1">
    <el-row class="edit-page-modular-allotcar">
        <el-col :span="4">
          <el-input class="input-group" v-bind:disabled="disabledInput" disabled value="xxxxxxxxx">
            <label class="radio-label" slot="prepend" >合同编号: </label>
          </el-input>
        </el-col>
        <el-col :span="4">
          <el-input class="input-group" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >发车日期: </label></el-input>
        </el-col>
        <el-col :span="4">
    ...
    <el-row class="edit-page-modular-allotcar">
        <div>&nbsp;&nbsp;本单费用：</div>
        <el-col :span="4">
          <el-input class="input-group" v-model="result.xf" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >现付驾驶员: </label></el-input>
        </el-col>
        <el-col :span="4">
          <el-input class="input-group" v-model="result.df" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >到付驾驶员: </label></el-input>
        </el-col>
        <el-col :span="4">
          <el-input class="input-group" v-model="result.hf" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >回付驾驶员: </label></el-input>
        </el-col>
    </el-row>
    <el-row class="edit-page-modular-allotcar">
        <el-col :span="4">
          <el-input class="input-group" v-model="result.hf" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >油卡卡号: </label></el-input>
        </el-col>
        <el-col :span="4">
          <el-input class="input-group"  v-model="result.hf" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >油卡公司: </label></el-input>
        </el-col>
        <el-col :span="4">
          <el-input class="input-group" v-model="result.hf" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >油卡驾驶员: </label></el-input>
        </el-col>
    </el-row>
    <el-row class="edit-page-modular-allotcar">
        <el-col :span="4">
          <el-input class="input-group" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >封 布 费 : </label></el-input>
        </el-col>
        <el-col :span="4">
          <el-input class="input-group" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >保 险 费 : </label></el-input>
        </el-col>
        <el-col :span="4">
          <el-input class="input-group" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >装 卸 费 : </label></el-input>
        </el-col>
    </el-row>

    <el-row class="edit-page-modular-allotcar">
        <el-col :span="4">
          <el-input class="input-group" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >落 地 费 : </label></el-input>
        </el-col>
        <el-col :span="4">
          <el-input class="input-group" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >其他费用: </label></el-input>
        </el-col>
        <el-col :span="4">
    ...
    <el-row class="edit-page-modular-allotcar">
        <el-col :span="12">
          <el-input class="input-group" v-bind:disabled="disabledInput"><label class="radio-label" slot="prepend" >费用合计: </label></el-input>
        </el-col>
    </el-row>
    ...
    <el-col class="overflow-x-auto " :span="12">
        ...
        <!-- <el-table
          ...
          <el-table-column
            ...
            <el-table-column   v-for="item in tableColumns2" v-if="choosenColumns.indexOf(item.label) > -1" :key="item.prop" :prop="item.prop" :label="item.label" :width="item.width">
              <template slot-scope="scope">
                  <div v-if="scope.$index === 0 && openColumnSearch">
                      <el-input   v-model="columnSearch[scope.column.property]" size="mini" @keyup.enter.native="handleColumnSearch"></el-input>
                  </div>
        ...
        <el-footer class="ac-footer  d-flex justify-content-center">
            <span>
                <el-button type="info" size="mini" @click="dialogChooseColumnVisible = true">列选择1</el-button>
                    ...
                    <el-row class="posi-rela right_r1" style="  margin-bottom: 10px">
                        ...
                        <el-table
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                   <!-- <el-input size="mini" v-model="scope.row.site" placeholder=""></el-input> -->
                                   <el-select v-model="scope.row.site" @change="bb" filterable placeholder="请选择">
                                        <el-option
                                        v-for="item in customerList" 
                                        :key="item.value"
                                        :label="item.Org_name"
  ...
  methods: {
    ...
    handleDelete(index, row) {
      if (row[index].num > 0) {
        this.$confirm('该卸货网点下有关联的运单，是否删除卸货点？', '提示', {
          ...
          //   leftMainfestIds.push(leftTable[i].manifest.manifest_id);
          // }
          ...
          for (let i = 0; i < row[0].datas.length; i++) {
            ...
            if (!addManifest) {
              ...
              console.log('addManifest', addManifest)
          ...
          console.log('leftTable111111', leftTable)
    ...
    fetchData() {
      ...
      if (id) {
        ...
        this.getDepartureInfo(id, this.Create_Org_ID) // 获取tab页 卸货网点对应的数据
      } else {
        this.editId = false
        // 新增数据
      }
      ...
      axios.post(url.apiUrl() + '/api/Departure/GetDepartureLeftDetail', data1)
        .then(function(val) {
          if (val.data.error === '') {
            ...
            table2Info.forEach(i => {
              dataInfo.forEach(ele => {
                const stocks = ele.stocks
                stocks.forEach(item => {
                  if (item.org_id == i.site) {
                    const a = Object.assign(item, ele.manifest)
                    i.datas.push(a)
                  }
                })
            ...
            console.log('table2Info', table2Info)
      ...
      axios.post(url.apiUrl() + '/api/Departure/DepartureById?departure_id=' + id)
        .then(function(msg) {
          if (msg.data.error === '') {
            ...
            console.info('tableData2', _this.tableData2)
          } else {
