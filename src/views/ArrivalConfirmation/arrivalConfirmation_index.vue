<template>
    <el-container class="ArrivalConfirmation">
        <el-header class="ArrivalConfirmation-header" style='height: 80px'>
            <!-- tab按钮 -->
...
export default {
  ...
  mounted() {
    ...
    document.querySelector('.ArrivalConfirmation').style.height = areaBoxHeight + 'px'
...
.ArrivalConfirmation .ArrivalConfirmation-footer{text-align: center;}
