<template>
  <div class="app-container a1">
    <el-row class="buttonBox">
      ...
      <el-button type="page-btn-group" class="page-btn-group" size="mini" @click="editEave">保存</el-button>
    ...
    <el-row class="edit-page-modular">
      ...
      <el-col :span="11">
        <el-row>
          ...
          <el-col :span="12" class="aa d-flex align-items-center">
    ...
    <el-table class="edit-page-modular" 
      ...
      <el-table-column label="运费单价"  align="center">
        <template slot-scope="scope">
          <el-input class="input-group" v-bind:disabled="disabledInput" @change="ListOperation(scope.$index)" v-model="scope.row.m.Freight_Unitprice"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="运费金额"  align="center">
        <template slot-scope="scope">
          <el-input class="input-group" v-bind:disabled="disabledInput" v-model="scope.row.m.Freight_Totalprice"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="保险金额"  align="center">
        <template slot-scope="scope">
          <el-input class="input-group" v-bind:disabled="disabledInput" v-model="scope.row.m.Insurance_Amount"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="保费比"  align="center">
        <template slot-scope="scope">
          <el-input class="input-group" v-bind:disabled="disabledInput" v-model="scope.row.m.Premium_Ratio"></el-input>
        </template>
      </el-table-column>
        ...
        <div class="edit-Settlement-d">付款方式</div>
          <el-row>
            ...
            <el-col :span="8">
              ...
              <el-input type="number" class="input-group" disabled v-bind:disabled="result.payme_value == 1 ? false : true" v-model="result.moneyxf" ><label class="radio-label" slot="prepend" >现　　付: </label></el-input>
            </el-col>
            <el-col :span="8">
              
              <el-input type="number" class="input-group" disabled v-bind:disabled="result.payme_value == 2 ? false : true" v-model="result.moneydf"><label class="radio-label" slot="prepend" >到　　付: </label></el-input>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              
              <el-input type="number" class="input-group" disabled v-bind:disabled="result.payme_value == 3 ? false : true" v-model="result.moneyqf"><label class="radio-label" slot="prepend" >欠　　付: </label></el-input>
            </el-col>
            <el-col :span="8">
              
              <el-input type="number" class="input-group" disabled v-bind:disabled="result.payme_value == 4 ? false : true" v-model="result.moneyhdf"><label class="radio-label" slot="prepend" >回 单 付: </label></el-input>
            </el-col>
            <el-col :span="8">
              
              <el-input type="number" class="input-group" disabled v-bind:disabled="result.payme_value == 5 ? false : true" v-model="result.moneyfhyj"><label class="radio-label" slot="prepend" >发货月结: </label></el-input>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              
              <el-input type="number" class="input-group" disabled v-bind:disabled="result.payme_value == 6 ? false : true" v-model="result.moneyshyj"><label class="radio-label" slot="prepend" >收货月结: </label></el-input>
            </el-col>
            <el-col :span="8">
              
              <el-input type="number" class="input-group" disabled v-bind:disabled="result.payme_value == 7 ? false : true" v-model="result.moneyhddk"><label class="radio-label" slot="prepend" >货到打卡: </label></el-input>
            </el-col>
            <el-col :span="8">
              
              <el-input type="number" class="input-group" disabled v-bind:disabled="result.payme_value == 8 ? false : true" v-model="result.moneydkk"><label class="radio-label" slot="prepend" >贷 款 扣: </label></el-input>
            </el-col>
          </el-row>
        </el-col>
...
export default {
  ...
  methods: {
    ...
    GetMessage() { // 获取地址栏参数并赋值
      ...
      this.result.transportState_value = parseInt(this.urlMessage.manifest_state_id)
      this.result.tuoyundaozhan = this.urlMessage.arrival_city
      this.result.Arrival_Org_ID = parseInt(this.urlMessage.arrival_org_id)
      this.result.tuoyunfazhan = this.urlMessage.departure_city
      this.result.TypeOfShipping = parseInt(this.urlMessage.transportation_type)
      ...
      this.result.HandoverMethod = parseInt(this.urlMessage.transfer_mode)
      this.result.Return = parseInt(this.urlMessage.reciept_type)
      ...
      axios.post(url.apiUrl() + '/api/Manifest/DeleteManifest', arr)
        .then(function(val) {
          if (val.data.error == '') {
            ...
            _this.$router.push({ path: '/acceptancebilling/index' })
          } else {
            _this.$message.error(val.data.error)
          }
        })
          ...
          manifest_R_Manifest_Payments: [
            {
              ...
              Payment_Amount: this.result.moneyxf
            }
          ],
    ...
    cancel() { // 取消操作
      this.$router.push('/acceptancebilling/index')
    },
    ...
    ListOperation(i) { // 表格里面的运费金额
      if (this.result.list[i].b.Billing_method_id == 1) {
        this.result.list[i].m.Freight_Totalprice = parseInt(this.result.list[i].m.Goods_Piece) * parseInt(this.result.list[i].m.Freight_Unitprice)
      }

      if (this.result.list[i].b.Billing_method_id == 2) {
        this.result.list[i].m.Freight_Totalprice = parseInt(this.result.list[i].m.Goods_Weight) * parseInt(this.result.list[i].m.Freight_Unitprice) / 1000
      }

      if (this.result.list[i].b.Billing_method_id == 3) {
        this.result.list[i].m.Freight_Totalprice = parseInt(this.result.list[i].m.Goods_Volume) * parseInt(this.result.list[i].m.Freight_Unitprice)
      }
    ...
    Settlement() {
      ...
      this.CalculationFreight()
      this.moneyTotal = parseInt(this.result.yf ? this.result.yf : 0) +
      parseInt(this.result.sh ? this.result.sh : 0) +
      parseInt(this.result.th ? this.result.th : 0) +
      parseInt(this.result.zx ? this.result.zx : 0) +
      parseInt(this.result.bj ? this.result.bj : 0) +
      parseInt(this.result.bz ? this.result.bz : 0) +
      parseInt(this.result.cz ? this.result.cz : 0) +
      parseInt(this.result.other ? this.result.other : 0) +
      parseInt(this.result.yfjc ? this.result.yfjc : 0)
    }
  }
}
</script>
