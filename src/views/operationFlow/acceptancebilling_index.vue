    ...
    <el-container class="ac-container">
        ...
        <el-main class="ac-main flex-1 flex-cloumn pd-10">
            ...
            <el-form :inline="true" :model="formFilter" class="form-wrapper" size="mini">
                ...
                <el-form-item label="运单状态">
                    <el-select clearable multiple v-model="formFilter.carStatus" placeholder="请选择" >
                        <el-option 
        ...
        <el-footer class="ac-footer  d-flex justify-content-center">
            ...
            <el-pagination
                ...
                :page-sizes="[100, 200, 500, 1000 , materielSize > 1000 ? materielSize : 1000]"
                :page-size="pageSize"
                class="l"
...
export default {
  ...
  methods: {
    ...
    GetAllManifest() { // 获取所有的运输委托单
      ...
      axios.post(url.apiUrl() + '/api/Manifest/GetAllManifest', data1)
        .then(function(val) {
          console.log(val)
          if (val.data.error === '') {
            _this.tableData = val.data.data.rows.reverse();
    ...
    GoEditPage(row, event) {
      ...
      this.$router.push({ path: '/common/acceptancebilling/add', query: row })
      return
    },
